...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if(~isempty(linesensind))
		subplot(2,2,4);
		plot(viewmap12(1,:),viewmap12(2,:),'.-',viewmap34(1,:),viewmap34(2,:) ,'.-',linesens(1,:),linesens(2,:),cross12(1,:),cross12(2,:) ,'p-',cross34(1,:),cross34(2,:) ,'p-', linesensind,[lookahead,lookahead],'o-')
    end
	drawnow;pause(0.5);
end
